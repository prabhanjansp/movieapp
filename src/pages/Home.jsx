...
//         const trendingData = await fetchTrending(mediaType);
//         const popularData = await fetchPopular(mediaType);
...
//         description="Explore trending movies, popular TV shows, upcoming releases and more."
//       />
//       <Box sx={{ 
//         p: 2,
//         maxWidth: '100%',
